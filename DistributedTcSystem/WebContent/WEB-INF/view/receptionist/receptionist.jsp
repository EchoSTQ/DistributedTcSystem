...
<head>
    ...
    <script type="text/javascript">
        var _menus = {"menus":[
                {"menuid":"1","icon":"","menuname":"详单查询",//点击菜单进入sevlet判断要进入哪个菜单页面CheckViewServelet?method=toDayCheckView
                    "menus":[
                        {"menuid":"11","menuname":"打印详单","icon":"icon-exam","url":"ReceptionistviewServlet?method=toRDRview"}
                    ]
                }
