...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"电源管理",
							"menus":[
									{"menuid":"11","menuname":"开启/关闭中央空调","icon":"icon-exam","url":"AdminViewServlet?method=toPowerOnView"}
								]
						},
						{"menuid":"2","icon":"","menuname":"设置",
							"menus":[
									{"menuid":"21","menuname":"空调参数设置","icon":"icon-user-student","url":"AdminViewServlet?method=toSetParaView"},
								]
						},
						{"menuid":"3","icon":"","menuname":"服务",
							"menus":[
